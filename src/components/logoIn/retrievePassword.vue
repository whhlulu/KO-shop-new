        ...
        methods:{
            obtain(){
                ...
                var N = 60,
                    _this = this,
                    clear = null;
                this.axios.post(API_URL + 'Home/Register/re_send_binding',qs.stringify({
                    mobile:this.mobile
                })).then((res) => {
            ...
            logoIn(){
                this.axios.post(API_URL + 'Home/Register/find_pwd',qs.stringify({
                    mobile:this.mobile,
                    verify:this.msgimg,
                    code:this.message,
                    type:'Android'
            ...
            replace(){//换一换
                this.axios.post(API_URL + 'Home/Register/verify',qs.stringify({
                    type:'Android'
                })).then((res) => {
                    console.log(res)
