	...
	<div class="box" v-loading="loading">
		<div class="headMain">
			...
			<div class="shopTitle">
				...
				<div>
					<p>{{shophomedata.storeFans}}<br><span>粉丝数</span></p>
		...
		<div class="content">
			...
			<div v-if="titleData == 0">
				...
				<!-- 广告部分 -->
				<div class="advertImg" v-show="irregular.left.length!=0&&irregular.reight.length!=0">
	...
	.advertImg {
		...
		.box {
			...
			img {
				width: 100%;
				height: 2.5rem;
				border-bottom: .03rem solid #CECECE;
			}
		}
	}
